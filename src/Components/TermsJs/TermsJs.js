...
const TermsJs = () => {
  return (
    <div className={style.terms}>
      <h1 className={style.mainTitle}>Terms & Conditions</h1>
      <div>
        <h2 className={style.secondTitle}>Frequently Asked Questions</h2>
        <p className={style.text}>
          These terms and conditions outline the rules and regulations for the
          use of bit-trade's Website, located at btc-ex.org.
          <br /> By accessing this website we assume you accept these terms and
          conditions. Do not continue to use btc-ex.org if you do not agree to
      ...
      <div>
        <h2 className={style.secondTitle}>Cookies</h2>
        <p className={style.text}>
          We employ the use of cookies. By accessing btc-ex.org, you agreed to
          use cookies in agreement with the bit-trade's Privacy Policy.
      ...
      <div>
        <h2 className={style.secondTitle}>License</h2>
        <p className={style.text}>
          Unless otherwise stated, bit-trade and/or its licensors own the
          intellectual property rights for all material on btc-ex.org. All
          intellectual property rights are reserved. You may access this from
          btc-ex.org for your own personal use subjected to restrictions set in
          these terms and conditions.
          <br />
          <br /> You must not: <br />
          <ol type="1">
            <li> Republish material from btc-ex.org</li>
            <li> Sell, rent or sub-license material from btc-ex.org</li>
            <li>Reproduce, duplicate or copy material from btc-ex.org</li>
            <li> Redistribute content from btc-ex.org</li>
            <li> This Agreement shall begin on the date hereof.</li>
          </ol>
          Parts of this website offer an opportunity for users to post and
          exchange opinions and information in certain areas of the website.
          bit-trade does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of bit-trade,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, bit-trade shall
          not be liable for the Comments or for any liability, damages or
          expenses caused and/or suffered as a result of any use of and/or
          posting of and/or appearance of the Comments on this website.
          <br />
          btc-ex.org reserves the right to monitor all Comments and to remove
          ...
          <ol>
            ...
            <li>
              You hereby grant btc-ex.org a non-exclusive license to use,
      ...
      <div>
        <h2 className={style.secondTitle}>Hyperlinking to our Content</h2>
        <p className={style.text}>
          ...
          the hyperlink compensates the absence of btc-ex.org; and (d) the link
          is in the context of general resource information. <br /> These
          ...
          sending an e-mail to btc-ex.org. Please include your name, your
          ...
          <ol>
            ...
            <li>
              No use of btc-ex.org's logo or other artwork will be allowed for
      ...
      <div>
        <h2 className={style.secondTitle}>iFrames</h2>
        <p className={style.text}>
      ...
      <div>
        <h2 className={style.secondTitle}>Content Liability</h2>
        <p className={style.text}>
      ...
      <div>
        <h2 className={style.secondTitle}>Reservation of Rights</h2>
        <p className={style.text}>
      ...
      <div>
        <h2 className={style.secondTitle}>Removal of links from our website</h2>
        <p className={style.text}>
